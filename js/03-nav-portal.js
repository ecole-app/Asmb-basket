...
var ROOTS=["portal","plan","admin-login","inscription","communaute","auth","role-select","team-picker","parent-home","parent-equipe","parent-events","parent-stats","coach-equipe","elite","tutoriel","joueur"];
...
function showScr(id){
 ...
 if(navEl)navEl.style.display=(id==="role-select"||id==="auth")?"none":"flex";
